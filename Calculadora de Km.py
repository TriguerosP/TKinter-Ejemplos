...
ventana = tk.Tk()
ventana.title("Conversor de Kilometros a Millas")  # Corregido "Kilomettros"
ventana.geometry("300x150")

etiqueta_instruccion = tk.Label(ventana, text="Ingrese la distancia en kilometros: ")
etiqueta_instruccion.grid(row=0, column=0, columnspan=2, padx=10, pady=10)  # Corregido "colum" a "column"

entrada_kilometros = tk.Entry(ventana)
entrada_kilometros.grid(row=1, column=0, padx=10, pady=10)  # Corregido "colum" a "column"
